...
$(document).ready(function () {
	...
	var textWrapper7 = document.querySelector('.ml7 .letters');
	...
	var textWrapper8 = document.querySelector('.ml8 .letters');
	...
	var textWrapper21 = document.querySelector('.ml21 .letters');
	textWrapper21.innerHTML = textWrapper21.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
	...
	var textWrapper22 = document.querySelector('.ml22 .letters');
	textWrapper22.innerHTML = textWrapper22.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
	...
	var textWrapper23 = document.querySelector('.ml23 .letters');
	textWrapper23.innerHTML = textWrapper23.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
	...
	var textWrapper24 = document.querySelector('.ml24 .letters');
	textWrapper24.innerHTML = textWrapper24.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
	...
	$('.ml9 .words').lettering('words')
	let i = 1;
	do {
		var ii = i * 50
		$('.ml9 .word' + i).addClass('word');
		$('.ml9 .word' + i).addClass('wow');
		$('.ml9 .word' + i).addClass('fadeInUp');
		$('.ml9 .word' + i).attr('data-wow-delay', ii + 'ms');
